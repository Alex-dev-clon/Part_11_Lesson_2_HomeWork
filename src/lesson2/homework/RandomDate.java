...
public @interface RandomDate {
    long min() default 1_704_056_400_000L; // количество миллисекунд на 1 января 2024 UTC-3

    long max() default 1_735_592_400_000L; // количество миллисекунд на 31 декабря 2024 UTC-3
